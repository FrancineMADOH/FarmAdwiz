...
import 'package:flutterd/screen/pages/web/widget/nav_bar_web_button.dart';
                ...
                child: Row(
                  children: [
                    ...
                    InkWell(
                     ...
                     onHover: (hover){
                      ...
                      child: navBarWebButton(
                          name: "Home",
                          iconImage: _hoverButton[0]==true || _selectedButton[0] == true?"assets/icons/home_icon.png":"assets/icons/home_icon.png",
                    ...
                    InkWell(
                      ...
                      child: navBarWebButton(
                          name: "Messages",
                          iconImage: _hoverButton[2]==true || _selectedButton[2] == true ?"assets/icons/message_icon_selected.png":"assets/icons/message_icon.png",
                          sizingInformation: sizingInformation
                      ),
                    ),
                    ...
                    InkWell(
                      ...
                      child: navBarWebButton(
                          name: "Notification",
                          iconImage: _hoverButton[3]==true || _selectedButton[3]==true?"assets/icons/message_icon_selected.png":"assets/icons/notification_icon.png",
                          sizingInformation: sizingInformation
                      ),
                    ),
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text("Moi",style: TextStyle(color: Colors.white),),
